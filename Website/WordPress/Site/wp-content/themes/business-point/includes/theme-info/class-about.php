	...
	class Business_Point_About {
		...
		public function load_assets( $hook ) {
			...
			if ( 'appearance_page_' . $this->page_slug === $hook ) {
				...
				wp_enqueue_style( 'business-point-about', get_template_directory_uri() . '/includes/theme-info/css/about.css', array(), '1.0.0' );
				wp_enqueue_script( 'business-point-about', get_template_directory_uri() . '/includes/theme-info/js/about.js', array( 'jquery' ), '1.0.0' );
				$js_vars = array(
		...
		public function free_pro() {
		    ...
		    if ( ! empty( $free_pro ) ) {
		        ...
		        if ( ! empty( $free_pro ) && is_array( $free_pro ) ) {
		            ...
		            echo '<td></td>';
		            echo '<td colspan="2"><a href="https://promenadethemes.com/downloads/business-point-plus/" target="_blank" class="button button-primary button-hero">Business Point Plus</a></td>';
		            echo '</tr>';
