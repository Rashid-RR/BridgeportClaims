...
using BridgeportClaims.Web.Framework.Email;
...
using BridgeportClaims.Web.Framework.Properties.EmailTemplates;

namespace BridgeportClaims.Web.Framework.IoCConfig
{
