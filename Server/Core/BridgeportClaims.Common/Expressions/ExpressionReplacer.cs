...
namespace BridgeportClaims.Common.Expressions
{
    ...
    public class ExpressionReplacer : ExpressionVisitor
    {
        ...
        public static Expression Replace(Expression expression, Expression searchFor, Expression replaceWith) 
            => new ExpressionReplacer(searchFor, replaceWith).Visit(expression);
        ...
        public override Expression Visit(Expression exp) => exp == _searchFor ? _replaceWith : base.Visit(exp);
    }
}