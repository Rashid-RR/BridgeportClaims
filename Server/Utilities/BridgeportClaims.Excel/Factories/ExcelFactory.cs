    ...
    public static class ExcelFactory
    {
        ...
        public static string GetBillingStatementExcelFilePathFromDataTable(DataTable dt, string workSheetName, string fileName, BillingStatementDto dto) =>
            DisposableService.Using(() => new ExcelPackage(), pck =>
            {
                ...
                var table = excelWorksheet.Tables[dt.TableName];
                ...
                excelWorksheet.Cells[rowCount + 1, colCount].Style.Border.Bottom.Style = ExcelBorderStyle.Thick;
                excelWorksheet.Cells[rowCount + 1, colCount].Style.Border.Top.Color.SetColor(Color.Black);
                excelWorksheet.Cells[rowCount + 1, colCount].Style.Border.Bottom.Color.SetColor(Color.Black);
