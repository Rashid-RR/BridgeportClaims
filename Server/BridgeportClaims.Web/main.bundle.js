...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_http_service__ = __webpack_require__(10);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__models_notification__ = __webpack_require__(36);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_http__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_http_service__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__models_notification__ = __webpack_require__(36);
...
var ConfirmEmailComponent = (function () {
    function ConfirmEmailComponent(route, http, req, router) {
        ...
        this.confirmed = 0;
        this.loading = true;
        router.routerState.root.queryParams.subscribe(function (data) { _this.code = data['code']; _this.user = data['userId']; });
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__models_notification__ = __webpack_require__(36);
            ...
            try {
                this.http.login('userName=' + this.form.get('email').value + '&password=' + this.form.get('password').value + "&grant_type=password", { 'Content-Type': 'x-www-form-urlencoded' }).subscribe(function (res) {
                    ...
                    _this.http.profile().map(function (res) { return res.json(); }).subscribe(function (res) {
                        _this.profileManager.profile = new __WEBPACK_IMPORTED_MODULE_5__models_profile__["a" /* UserProfile */](data.id || res.email, res.email, res.firstName, res.lastName, res.email, res.email, null, data.createdOn, res.roles);
                        _this.profileManager.setProfile(new __WEBPACK_IMPORTED_MODULE_5__models_profile__["a" /* UserProfile */](data.id || res.email, res.email, res.firstName, res.lastName, res.email, res.email, null, data.createdOn, res.roles));
                        var user = res;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_forms__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_http_service__ = __webpack_require__(10);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__models_notification__ = __webpack_require__(36);
...
var ProfileComponent = (function () {
    ...
    ProfileComponent.prototype.updateUserInfo = function () {
        ...
        if (this.form.valid && !this.loading) {
            this.loading = true;
            try {
                this.http.changeusername(this.form.value.firstName, this.form.value.lastName, '43b8b8cb-9f41-4904-9cee-df770efdb2bd').subscribe(function (res) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_http_service__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_forms__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__models_notification__ = __webpack_require__(36);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__http_service__ = __webpack_require__(10);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__http_service__ = __webpack_require__(10);
    ...
    ClaimManager.prototype.search = function (data) {
        ...
        this.http.getClaimsData(data).map(function (res) { return res.json(); })
            ...
            if (result.name) {
                ...
                claim.setClaimNotes(result.claimNote ? new __WEBPACK_IMPORTED_MODULE_2__models_claim_note__["a" /* ClaimNote */](result.claimNote.noteText, result.claimNote.noteType.key) : null);
