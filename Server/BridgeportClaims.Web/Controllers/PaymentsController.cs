            ...
            int pageSize, string secondSort = null, string secondSortDirection = null)
        {
            try
            {
                return await Task.Run(() => Ok(
                    _paymentsDataProvider.Value.GetPrescriptionPaymentsDtos(claimId, sort, sortDirection, page, pageSize,
        ...
        public async Task<IHttpActionResult> PostPayments(PostPaymentsModel model)
        {
            try
            {
                return await Task.Run(() =>
                {
                    ...
                    var postPaymentReturnDto = _paymentsDataProvider.Value.PostPayment(model.PrescriptionIds, model.CheckNumber,
