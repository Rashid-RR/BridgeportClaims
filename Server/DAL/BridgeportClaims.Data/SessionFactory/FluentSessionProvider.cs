		...
		public static ISessionFactory CreateSessionFactory()
		{
			...
			return Fluently.Configure()
				...
				.Mappings(m =>
				{
					...
					m.FluentMappings.Add<EpisodeNoteMap>();
					...
					m.FluentMappings.Add<InvoiceIndexMap>();
					...
					m.FluentMappings.Add<EpisodeTypeUsersMappingMap>();
					...
					m.FluentMappings.Add<DocumentTypeEpisodeTypeMappingMap>();
					...
					m.FluentMappings.Add<NotificationMap>();
					m.FluentMappings.Add<NotificationConfigMap>();
					m.FluentMappings.Add<NotificationTypeMap>();
				})
