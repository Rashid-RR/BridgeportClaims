...
GO
CREATE NONCLUSTERED INDEX [idxNLogLevelIncludes] ON [util].[NLog] ([Level]) INCLUDE ([Logged], [MachineName], [Message], [NLogID], [UserName]) WITH (FILLFACTOR=90, DATA_COMPRESSION = PAGE) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [idxNLogMachineName] ON [util].[NLog] ([MachineName]) WITH (FILLFACTOR=90, DATA_COMPRESSION = PAGE) ON [PRIMARY]
GO
