...
[DocumentDate] AS (CONVERT([date],substring([FileName],(4),(8)),(0))),
...
GO
ALTER TABLE [dbo].[Document] ADD CONSTRAINT [idxUqDocumentFileUrl] UNIQUE NONCLUSTERED  ([FileUrl]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
