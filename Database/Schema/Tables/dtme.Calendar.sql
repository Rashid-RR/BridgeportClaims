...
GO
CREATE NONCLUSTERED INDEX [idxCalendarCalendarYearCalendarMonth] ON [dtme].[Calendar] ([CalendarYear], [CalendarMonth]) WITH (FILLFACTOR=90, DATA_COMPRESSION = PAGE) ON [PRIMARY]
GO
