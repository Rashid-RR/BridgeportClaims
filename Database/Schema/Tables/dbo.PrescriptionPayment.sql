...
GO
CREATE NONCLUSTERED INDEX [idxPrescriptionPaymentCheckNumber] ON [dbo].[PrescriptionPayment] ([CheckNumber]) WITH (FILLFACTOR=90, DATA_COMPRESSION = PAGE) ON [PRIMARY]
GO
