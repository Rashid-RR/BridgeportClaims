...
[GenderCode] [char] (5) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
...
GO
ALTER TABLE [dbo].[Gender] ADD CONSTRAINT [pkGender] PRIMARY KEY CLUSTERED  ([GenderID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
