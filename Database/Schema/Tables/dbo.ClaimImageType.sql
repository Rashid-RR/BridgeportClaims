...
[CreatedOnUTC] [datetime2] NOT NULL CONSTRAINT [dfClaimImageTypeCreatedOnUTC] DEFAULT (sysdatetime()),
[UpdatedOnUTC] [datetime2] NOT NULL CONSTRAINT [dfClaimImageTypeUpdatedOnUTC] DEFAULT (sysdatetime()),
