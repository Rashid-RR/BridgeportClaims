...
[CreatedOn] [datetime2] NOT NULL CONSTRAINT [dfClaimImageTypeCreatedOnUTC] DEFAULT (sysdatetime()),
[UpdatedOn] [datetime2] NOT NULL CONSTRAINT [dfClaimImageTypeUpdatedOnUTC] DEFAULT (sysdatetime()),
