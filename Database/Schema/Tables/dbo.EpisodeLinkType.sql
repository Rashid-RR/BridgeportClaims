...
[CreatedOn] [datetime2] NOT NULL CONSTRAINT [dfEpisodeLinkTypeCreatedOnUTC] DEFAULT (sysdatetime()),
[UpdatedOn] [datetime2] NOT NULL CONSTRAINT [dfEpisodeLinkTypeUpdatedOnUTC] DEFAULT (sysdatetime()),
