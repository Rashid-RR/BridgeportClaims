...
[CreatedOnUTC] [datetime2] NOT NULL CONSTRAINT [dfEpisodeLinkTypeCreatedOnUTC] DEFAULT (sysdatetime()),
[UpdatedOnUTC] [datetime2] NOT NULL CONSTRAINT [dfEpisodeLinkTypeUpdatedOnUTC] DEFAULT (sysdatetime()),
