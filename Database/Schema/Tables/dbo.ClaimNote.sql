...
[CreatedOnUTC] [datetime2] NOT NULL CONSTRAINT [dfClaimNoteCreatedOnUTC] DEFAULT (sysdatetime()),
[UpdatedOnUTC] [datetime2] NOT NULL CONSTRAINT [dfClaimNoteUpdatedOnUTC] DEFAULT (sysdatetime()),
