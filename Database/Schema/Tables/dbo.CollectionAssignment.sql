...
GO
CREATE NONCLUSTERED INDEX [idxCollectionAssignmentModifiedByUserIDIncludes] ON [dbo].[CollectionAssignment] ([ModifiedByUserID]) INCLUDE ([CreatedOnUTC], [PayorID], [UpdatedOnUTC], [UserID]) WITH (FILLFACTOR=90, DATA_COMPRESSION = PAGE) ON [PRIMARY]
GO
