...
[CreatedOn] [datetime2] NOT NULL CONSTRAINT [dfPrescriptionNoteCreatedOnUTC] DEFAULT (sysdatetime()),
[UpdatedOn] [datetime2] NOT NULL CONSTRAINT [dfPrescriptionNoteUpdatedOnUTC] DEFAULT (sysdatetime()),
