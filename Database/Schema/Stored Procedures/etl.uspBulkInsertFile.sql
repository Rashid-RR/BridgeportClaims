...
/*
	...
	Description:	
	Sample Execute:
					EXEC etl.uspBulkInsertFile 'D:\TFS\JGPortal\LakerFilesBackup\Billing_Claim_File_20170620.csv'
*/
...
AS BEGIN
	...
	BEGIN TRY	
		BEGIN TRAN
			TRUNCATE TABLE [etl].[StagedLakerFile]
			...
			TRUNCATE TABLE [etl].[BulkInsertLakerFile]
		IF @@TRANCOUNT > 0
			COMMIT
	END TRY
    BEGIN CATCH
