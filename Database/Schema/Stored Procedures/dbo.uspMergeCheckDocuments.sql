...
/*
	...
	Description:	Uses a DataTable to do a SQL MERGE on [dbo].[vwCheckDocument] (a view that filters to only check document types).
	Sample Execute:
					EXEC [dbo].[uspMergeCheckDocuments]
*/
CREATE PROCEDURE [dbo].[uspMergeCheckDocuments]
